...
/**
 * A class that defines shared constants of the SharedProperties used by Termux
 * app and its plugins.
...
public final class TermuxPropertyConstants {
        ...
        public static final String KEY_DISABLE_FILE_SHARE_RECEIVER = "disable-file-share-receiver"; // Default:
                                                                                                    // "disable-file-share-receiver"

        /** Defines the key for whether file view receiver of the app is enabled. */
        public static final String KEY_DISABLE_FILE_VIEW_RECEIVER = "disable-file-view-receiver"; // Default:
                                                                                                  // "disable-file-view-receiver"

        /** Defines the key for whether hardware keyboard shortcuts are enabled. */
        public static final String KEY_DISABLE_HARDWARE_KEYBOARD_SHORTCUTS = "disable-hardware-keyboard-shortcuts"; // Default:
                                                                                                                    // "disable-hardware-keyboard-shortcuts"

        /**
         * Defines the key for whether a toast will be shown when user changes the
         * terminal session
         */
        public static final String KEY_DISABLE_TERMINAL_SESSION_CHANGE_TOAST = "disable-terminal-session-change-toast"; // Default:
                                                                                                                        // "disable-terminal-session-change-toast"

        /**
         * Defines the key for whether to enforce character based input to fix the issue
         * where for some devices like Samsung, the letters might not appear until enter
         * is pressed
         */
        public static final String KEY_ENFORCE_CHAR_BASED_INPUT = "enforce-char-based-input"; // Default:
                                                                                              // "enforce-char-based-input"

        /**
         * Defines the key for whether text for the extra keys buttons should be all
         * capitalized automatically
         */
        public static final String KEY_EXTRA_KEYS_TEXT_ALL_CAPS = "extra-keys-text-all-caps"; // Default:
                                                                                              // "extra-keys-text-all-caps"

        /**
         * Defines the key for whether to hide soft keyboard when termux app is started
         */
        public static final String KEY_HIDE_SOFT_KEYBOARD_ON_STARTUP = "hide-soft-keyboard-on-startup"; // Default:
                                                                                                        // "hide-soft-keyboard-on-startup"

        /**
         * Defines the key for whether the {@link TermuxAmSocketServer} should be run at
         * app startup
         */
        public static final String KEY_RUN_TERMUX_AM_SOCKET_SERVER = "run-termux-am-socket-server"; // Default:
                                                                                                    // "run-termux-am-socket-server"

        /**
         * Defines the key for whether url links in terminal transcript will
         * automatically open on click or on tap
         */
        public static final String KEY_TERMINAL_ONCLICK_URL_OPEN = "terminal-onclick-url-open"; // Default:
        ...
        /**
         * Defines the key for whether to use ctrl space workaround to fix the issue
         * where ctrl+space does not work on some ROMs
         */
        public static final String KEY_USE_CTRL_SPACE_WORKAROUND = "ctrl-space-workaround"; // Default:
        ...
        public static final String KEY_USE_FULLSCREEN_WORKAROUND = "use-fullscreen-workaround"; // Default:
        ...
        /**
         * Defines the bidirectional map for bell behaviour values and their internal
         * values
         */
        ...
        public static final String KEY_TERMINAL_CURSOR_BLINK_RATE = "terminal-cursor-blink-rate"; // Default:
        ...
        public static final String KEY_TERMINAL_CURSOR_STYLE = "terminal-cursor-style"; // Default:
        ...
        /**
         * Defines the bidirectional map for terminal cursor styles and their internal
         * values
         */
        ...
        /**
         * Defines the key for how many days old the access time should be of files that
         * should be
         * deleted from $TMPDIR on termux exit.
         * `-1` for none, `0` for all and `> 0` for x days.
         */
        public static final String KEY_DELETE_TMPDIR_FILES_OLDER_THAN_X_DAYS_ON_EXIT = "delete-tmpdir-files-older-than-x-days-on-exit"; // Default:
        ...
        public static final String KEY_TERMINAL_MARGIN_HORIZONTAL = "terminal-margin-horizontal"; // Default:
        ...
        public static final String KEY_TERMINAL_MARGIN_VERTICAL = "terminal-margin-vertical"; // Default:
        ...
        public static final String KEY_TERMINAL_TRANSCRIPT_ROWS = "terminal-transcript-rows"; // Default:
        ...
        public static final String KEY_TERMINAL_TOOLBAR_HEIGHT_SCALE_FACTOR = "terminal-toolbar-height"; // Default:
        ...
        public static final String KEY_SHORTCUT_CREATE_SESSION = "shortcut.create-session"; // Default:
                                                                                            // "shortcut.create-session"
        /** Defines the key for next session shortcut */
        public static final String KEY_SHORTCUT_NEXT_SESSION = "shortcut.next-session"; // Default:
                                                                                        // "shortcut.next-session"
        /** Defines the key for previous session shortcut */
        public static final String KEY_SHORTCUT_PREVIOUS_SESSION = "shortcut.previous-session"; // Default:
                                                                                                // "shortcut.previous-session"
        /** Defines the key for rename session shortcut */
        public static final String KEY_SHORTCUT_RENAME_SESSION = "shortcut.rename-session"; // Default:
        ...
        /**
         * Defines the bidirectional map for session shortcut values and their internal
         * actions
         */
        ...
        /**
         * Defines the key for whether back key will behave as escape key or literal
         * back key
         */
        ...
        /**
         * Defines the bidirectional map for back key behaviour values and their
         * internal values
         */
        ...
        public static final String KEY_DEFAULT_WORKING_DIRECTORY = "default-working-directory"; // Default:
        ...
        public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},{macro: 'CTRL c', display: 'Ctrl+C'},'UP','END','PGUP'], ['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN'], [{macro: 'claude ENTER', display: 'claude'}, {macro: 'claude SPACE -r ENTER', display: 'claude -r'}, {macro: 'cursor-agent ENTER', display: 'cursor'}, {macro: 'codex ENTER', display: 'codex'}, {macro: 'gemini ENTER', display: 'gemini'}, {macro: 'exit ENTER', display: 'exit'}]]"; // Triple
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       // row
        // row
        // row
        ...
        /**
         * Defines the bidirectional map for {@link NightMode} values and their internal
         * values
         */
        ...
        /**
         * Defines the key for whether toggle soft keyboard request will show/hide or
         * enable/disable keyboard
         */
        public static final String KEY_SOFT_KEYBOARD_TOGGLE_BEHAVIOUR = "soft-keyboard-toggle-behaviour"; // Default:
        ...
        /**
         * Defines the bidirectional map for toggle soft keyboard behaviour values and
        ...
        public static final ImmutableBiMap<String, String> MAP_SOFT_KEYBOARD_TOGGLE_BEHAVIOUR = new ImmutableBiMap.Builder<String, String>()
                        .put(IVALUE_SOFT_KEYBOARD_TOGGLE_BEHAVIOUR_SHOW_HIDE,
        ...
        /**
         * Defines the key for whether volume keys will behave as virtual or literal
         * volume keys
         */
        ...
        /**
         * Defines the bidirectional map for volume keys behaviour values and their
         * internal values
         */
         ...
         * Setting this to {@code null} will make {@link SharedProperties} throw an
         * exception.
         */
         ...
         * default: true
         */
        public static final Set<String> TERMUX_DEFAULT_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(
                        Arrays.asList(
                                        KEY_EXTRA_KEYS_TEXT_ALL_CAPS,
                                        KEY_RUN_TERMUX_AM_SOCKET_SERVER));

        /**
         * Defines the set for keys loaded by termux that have default inverted boolean
         * behaviour with false as default.
         * "false" -> true
         * "true" -> false
         * default: false
         */
        ...
        /**
         * Defines the set for keys loaded by termux that have default inverted boolean
         * behaviour with true as default.
         * "false" -> true
         * "true" -> false
         * default: true
         */
